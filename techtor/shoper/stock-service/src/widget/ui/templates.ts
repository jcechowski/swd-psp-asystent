...
/** Baner "Zapytaj o dostępność" — koszyk ODBLOKOWANY */
...
/** Baner "Przekroczono ilość" — koszyk ZABLOKOWANY */
export function overlimitBannerHtml(stock: number): string {
  return `<div class="techtor-banner techtor-banner--warning" id="techtor-overlimit-banner">
    <div class="techtor-banner__row">${ICON_WARN}<span class="techtor-banner__text techtor-banner__text--amber">Brak wystarczającej ilości towaru</span></div>
    <p class="techtor-banner__detail">W magazynie posiadamy <strong>${stock} szt.</strong> Zapytaj o dostępność większej ilości.</p>
